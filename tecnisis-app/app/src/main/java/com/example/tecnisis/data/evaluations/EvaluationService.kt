...
interface EvaluationService {
    @PUT("artistic-evaluations/v1/api/{id}")
    ...
    @PUT("economic-evaluations/v1/api/{id}")
    ...
    suspend fun getEconomicEvaluationByRequest(@Header("Authorization") token: String, @Path("id") id: Long): Response<EconomicEvaluationResponse>
}